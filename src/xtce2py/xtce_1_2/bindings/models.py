...
class RangeFormType(Enum):
    """Defines whether the defined range between the minimum and maximum is
    the outside or inside the range being defined.
...
class ArgumentSequenceEntryType:
    ...
    location_in_container_in_bits: Optional[ArgumentLocationInContainerInBitsType] = (
        field(
            default=None,
            metadata={
...
class ArgumentTypeSetType:
    ...
    :ivar boolean_argument_type: Describe an argument type that has an
        ...
        enumeration.
    :ivar relative_time_argument_type: Describe an argument type that has
